__kernel void mac_kernel_vec4(__constant uint* restrict coefficient,
...
{  
  ...
  uint4 coeff4 = (uint4)(coefficient[index4.x], coefficient[index4.y], coefficient[index4.z], coefficient[index4.w]); 
